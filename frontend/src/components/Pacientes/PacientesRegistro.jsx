    ...
    <div className="container-fluid opacity-chg-low">
      ...
      <div className="row">
        ...
        >
                ...
                <div className="input-group mb-2">
                  ...
                  {accion === "R" ? (
                    <div className="input-group my-1">
                      <input type="file" name="image-file" accept="image/*" className="pe-1"/>
                    </div>
                  ) : (
                    <br />
                  )}
          ...
          {/* botones */}
          <div className="row">
            {accion !== "C" && <button type="submit" className="btn btn-grabar my-2 shadow-small">GRABAR <i className="bi bi-check-lg ms-1"></i></button>}
            <button onClick={(e) => regresarListado()} className="btn btn-volver shadow-small my-2">
